...
var questions = [
  ...
  {
    q: "Who does Aladdin have a crush on?",
    a: ["Mulan", "Jasmine", "Pocahontas", "Cinderella"],
    c: "Jasmine"
  },
  {
    q: "What kind of creature is Tarzan?",
    a: ["Chimpanzee", "Ape", "Bonobo", "Human"],
    c: "Human"
  },
  {
    q: "Which glass slipper did Cinderella leave at the ball?",
...
function endGame() {
  ...
  $("#restart").html(
    "<p></p><button type='button' class='btn btn-success start'>Restart Game</button>"
  );
  stop();
  qArrayPos = 0;
}
